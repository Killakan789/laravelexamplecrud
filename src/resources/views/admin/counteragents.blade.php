...
<div id="app">
    ...
    <main class="py-4">
        <div class="row text-center">
            <div class="col-lg-12">
                <a href="/counteragents/add" class="btn btn-success">Create</a>
            </div>
        </div>
        <br>
        <div class="row">
                ...
                <table class="table">
                    ...
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td>{{ $post->name }}</td>
                            <td>
                                <a class="btn btn-info" href="/counteragents/{{ $post->id }}">Edit</a>
                                <a class="btn btn-danger" href="/counteragents/delete/{{ $post->id }}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
